...
NAME_B = cub3D_bonus
CC = cc
FLAGC = -Wall  -Wextra -Werror -I./libft -g -O3 #-g -fsanitize=address
...
BONUS = bonus_part/cub3D.c bonus_part/raycasting.c bonus_part/raycasting_utils.c bonus_part/textels.c bonus_part/draw_minimap_fc.c bonus_part/key_hook.c bonus_part/free_all.c parsing/valid_map.c parsing/check_file.c parsing/load_map.c parsing/check_information.c parsing/check_map.c parsing/map_len.c parsing/check_error_information.c parsing/check_error_information_utils.c parsing/split_newline_information.c \
	libft/ft_split.c libft/ft_substr.c  libft/ft_strlen.c libft/ft_strjoin.c libft/ft_strchr.c libft/ft_strdup.c libft/ft_isdigit.c\
	libft/ft_calloc.c libft/ft_putchar_fd.c libft/ft_putstr_fd.c libft/ft_strnstr.c libft/ft_strtrim.c libft/ft_strcmp.c libft/ft_atoi.c\
	get_next_line/get_next_line.c get_next_line/get_next_line_utils.c
...
clean:
	rm -rf $(OBJ) $(OBJ_BONUS)
fclean: clean
	rm -rf $(NAME) $(NAME_B) ./mlx42/libmlx42.a
re: fclean all