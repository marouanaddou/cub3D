NAME = cub3D
CC = cc
FLAGC = -Wall  -Wextra -Werror -I./libft -fsanitize=address -g
SRC = cub3D.c free_all.c parsing/check_file.c parsing/load_map.c parsing/check_information.c parsing/check_map.c parsing/fill_map.c\
